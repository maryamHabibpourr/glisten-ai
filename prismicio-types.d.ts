...
export interface SettingsDocumentDataNavigationItem {
  ...
  /**
   * CTN Button field in *settings → Navigation*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: settings.navigation[].ctn_button
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
  ctn_button: prismic.BooleanField;
}
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Botton Link field in *Hero → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.botton_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  botton_link: prismic.LinkField;
...
export interface ShowCaseSliceDefaultPrimary {
   ...
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<"cycle" | "geer">;
